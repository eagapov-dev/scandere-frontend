...
export default function AdminCategories() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || 'Failed to save category. Please check all fields.');
    }
  };
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Slug <span className="text-gray-400 text-xs">(optional - auto-generated from name)</span>
                </label>
                <input
                  type="text"
                  value={formData.slug}
                  ...
                  placeholder="e.g., templates"
                />
                <p className="text-xs text-gray-500 mt-1">URL-friendly version. Leave empty to auto-generate.</p>
              </div>
